        ...
        const fetchData = async () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    weight: typeof petData.weight === 'number' ? petData.weight : 0,
                        ...
                        <main className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-950">
                            <div className="flex items-center justify-center h-full">
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">Loading pet details...</p>
                                </div>
                            </div>
                        </main>
                    </div>
                                ...
                                <Card className="bg-white dark:bg-black border-gray-200 dark:border-gray-800 shadow-sm">
                                    ...
                                    <CardContent className="space-y-6">
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <Label htmlFor="name" className="text-gray-900 dark:text-white font-medium">Pet Name *</Label>
                                                <Input
                                                    id="name"
                                                    value={formData.name}
                                            ...
                                            <div>
                                                <Label htmlFor="breed" className="text-gray-900 dark:text-white font-medium">Breed *</Label>
                                                <Input
                                                    id="breed"
                                            ...
                                            <div>
                                                <Label htmlFor="age" className="text-gray-900 dark:text-white font-medium">Age (years) *</Label>
                                                <Input
                                                    id="age"
                                                    type="number"
                                                    min="0"
                                                    max="50"
                                                    value={formData.age || ""}
                                                    onChange={(e) => handleInputChange("age", e.target.value ? Number.parseInt(e.target.value) : 0)}
                                            ...
                                            <div>
                                                <Label htmlFor="weight" className="text-gray-900 dark:text-white font-medium">Weight (kg) *</Label>
                                                <Input
                                                    id="weight"
                                                    type="number"
                                                    min="0"
                                                    ...
                                                    onChange={(e) => handleInputChange("weight", e.target.value ? Number.parseFloat(e.target.value) : 0)}
