...
export interface IShopService {
  ...
  getShopSubscription(shopId: string): Promise<'free' | 'basic' | 'premium'>;
  ...
  updateShopSubscription(shopId: string, subscription: 'free' | 'basic' | 'premium'): Promise<ShopResponseDTO>;
