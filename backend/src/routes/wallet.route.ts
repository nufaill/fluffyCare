...
router.post(
  '/user/create',
  userDependencies.authMiddleware.authenticate('user') as RequestHandler,
...
router.post(
  '/shop/create',
  shopDependencies.authMiddleware.authenticate('shop') as RequestHandler,
  walletDependencies.walletController.createWallet.bind(walletDependencies.walletController) as RequestHandler
);
...
router.post(
  '/admin/create',
  adminDependencies.authMiddleware.authenticate('admin') as RequestHandler,
  walletDependencies.walletController.createWallet.bind(walletDependencies.walletController) as RequestHandler
);
